...
export const metadata = {
  title: "Department Leave Request | Leaves | WorkHub",
};

export default async function ManagerLeaveDetailsPage({
  params,
  searchParams,
}: {
  ...
  const request = await getLeaveRequestDetails(user, requestId, "manager");
