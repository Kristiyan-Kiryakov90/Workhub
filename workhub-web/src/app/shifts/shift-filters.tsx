...
export function ShiftFilters({
  ...
  const [employeeValue, setEmployeeValue] = useState(assignedToUserId);
  ...
  const hasPendingChanges =
    ...
    employeeValue !== assignedToUserId ||
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(() => {
      ...
      setParam(params, "assignedToUserId", employeeValue);
      setParam(params, "dateRange", dateRangeValue);
      params.delete("myUpcomingPage");
      params.delete("myArchivePage");
      params.delete("departmentUpcomingPage");
      params.delete("departmentArchivePage");
      params.delete("organizationUpcomingPage");
      params.delete("organizationArchivePage");
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        <label className="block">
          ...
          <input
            ...
            placeholder="Title, location, or employee"
